		...
		<div class="size1 p-l-15 p-r-15 p-t-30 p-b-50">
			...
			<div class="wsize1 m-lr-auto">
				<p class="txt-center l1-txt1 p-b-60">
					bienvenue sur notre <span class="l1-txt2"> espace client nous assurons la sécurité</span>de vos données
				</p>
				...
				<form class="w-full flex-w flex-c-m validate-form">
					...
					<button class=" size3 m1-txt2 how-btn1 trans-04 m-b-20">
					<a href="login.php" style="color: white;">	SGC bank</a>
					</button> <br> <br>
